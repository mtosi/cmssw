...
class Track2TrackValidator : public DQMEDAnalyzer {
 ...
 protected:
  ...
  void book_associate_tracks_histos(DQMStore::IBooker & ibooker, assME& mes, TString label, std::string & dir);

  void fill_generic_tracks_histos(generalME& mes, reco::Track* trk, reco::BeamSpot* bs, reco::Vertex* pv);
  void fill_associate_tracks_histos(assME& mes, reco::Track* mon, reco::Track* ref, reco::BeamSpot* bs, reco::Vertex* pv);
