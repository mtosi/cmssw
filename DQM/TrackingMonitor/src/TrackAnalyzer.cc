...
TrackAnalyzer::TrackAnalyzer(const edm::ParameterSet& iConfig) 
    ...
    , doTrack2DChi2Plots_              ( conf_.getParameter<bool>("doGoodTrack2DChi2Plots") )
...
void TrackAnalyzer::beginRun(DQMStore * dqmStore_) 
{
  ...
  std::cout << "[TrackAnalyzer::beginRun] .. starting" << std::endl;
...
void TrackAnalyzer::bookHistosForHitProperties(DQMStore * dqmStore_) {
  ...
  std::cout << "[TrackAnalyzer::bookHistosForHitProperties] .. starting" << std::endl;
    ...
    if ( doHitPropertiesPlots_ || doAllPlots_ ){
      ...
      NumberOfValidRecHitsPerTrack = dqmStore_->book1D(histname+CatagoryName, histname+CatagoryName, TKHitBin, TKHitMin, TKHitMax);
      ...
      NumberOfLostRecHitsPerTrack = dqmStore_->book1D(histname+CatagoryName, histname+CatagoryName, TKLostBin, TKLostMin, TKLostMax);
    ...
    NumberOfRecHitsPerTrackVsPhi = dqmStore_->bookProfile(histname, histname, PhiBin, PhiMin, PhiMax, RecHitBin, RecHitMin, RecHitMax,"");
    NumberOfRecHitsPerTrackVsPhi->setAxisTitle("Track #phi",1);
    NumberOfRecHitsPerTrackVsPhi->setAxisTitle("Number of RecHits of each Track",2);

    if (doThetaPlots_) {
      histname = "NumberOfRecHitsPerTrackVsTheta_";
      NumberOfRecHitsPerTrackVsTheta = dqmStore_->bookProfile(histname, histname, ThetaBin, ThetaMin, ThetaMax, RecHitBin, RecHitMin, RecHitMax,"");
      NumberOfRecHitsPerTrackVsTheta->setAxisTitle("Track #phi",1);
      NumberOfRecHitsPerTrackVsTheta->setAxisTitle("Number of RecHits of each Track",2);
    }
    histname = "NumberOfRecHitsPerTrackVsEta_";
    NumberOfRecHitsPerTrackVsEta = dqmStore_->bookProfile(histname, histname, EtaBin, EtaMin, EtaMax, RecHitBin, RecHitMin, RecHitMax,"");
    NumberOfRecHitsPerTrackVsEta->setAxisTitle("Track #eta",1);
    NumberOfRecHitsPerTrackVsEta->setAxisTitle("Number of RecHits of each Track",2);

    histname = "NumberOfValidRecHitsPerTrackVsPhi_";
    NumberOfValidRecHitsPerTrackVsPhi = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, PhiBin, PhiMin, PhiMax, RecHitMin, RecHitMax,"");
    NumberOfValidRecHitsPerTrackVsPhi->setAxisTitle("Track #phi",1);
    NumberOfValidRecHitsPerTrackVsPhi->setAxisTitle("Number of valid RecHits of each Track",2);
    
    histname = "NumberOfValidRecHitsPerTrackVsEta_";
    NumberOfValidRecHitsPerTrackVsEta = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, EtaBin, EtaMin, EtaMax, RecHitMin, RecHitMax,"");
    NumberOfValidRecHitsPerTrackVsEta->setAxisTitle("Track #eta",1);
    NumberOfValidRecHitsPerTrackVsEta->setAxisTitle("Number of valid RecHits of each Track",2);
    
    //////////////////////////////////////////
    histname = "NumberOfLayersPerTrackVsPhi_";
    NumberOfLayersPerTrackVsPhi = dqmStore_->bookProfile(histname, histname, PhiBin, PhiMin, PhiMax, RecLayBin, RecLayMin, RecLayMax,"");
    NumberOfLayersPerTrackVsPhi->setAxisTitle("Track #phi",1);
    NumberOfLayersPerTrackVsPhi->setAxisTitle("Number of Layers of each Track",2);

    if (doThetaPlots_) {
      histname = "NumberOfLayersPerTrackVsTheta_";
      NumberOfLayersPerTrackVsTheta = dqmStore_->bookProfile(histname, histname, ThetaBin, ThetaMin, ThetaMax, RecLayBin, RecLayMin, RecLayMax,"");
      NumberOfLayersPerTrackVsTheta->setAxisTitle("Track #phi",1);
      NumberOfLayersPerTrackVsTheta->setAxisTitle("Number of Layers of each Track",2);
    }
    histname = "NumberOfLayersPerTrackVsEta_";
    NumberOfLayersPerTrackVsEta = dqmStore_->bookProfile(histname, histname, EtaBin, EtaMin, EtaMax, RecLayBin, RecLayMin, RecLayMax,"");
    NumberOfLayersPerTrackVsEta->setAxisTitle("Track #eta",1);
    NumberOfLayersPerTrackVsEta->setAxisTitle("Number of Layers of each Track",2);
    ...
    if (doGeneralPropertiesPlots_ || doAllPlots_){
      ...
      xPointOfClosestApproachToPV = dqmStore_->book1D(histname+CatagoryName, histname+CatagoryName, VXBin, VXMin, VXMax);
      xPointOfClosestApproachToPV->setAxisTitle("x component of Track PCA to beam line (cm)",1);
      xPointOfClosestApproachToPV->setAxisTitle("Number of Tracks",2);
      
      histname = "yPointOfClosestApproachToPV_";
      yPointOfClosestApproachToPV = dqmStore_->book1D(histname+CatagoryName, histname+CatagoryName, VYBin, VYMin, VYMax);
      yPointOfClosestApproachToPV->setAxisTitle("y component of Track PCA to beam line (cm)",1);
      yPointOfClosestApproachToPV->setAxisTitle("Number of Tracks",2);

      histname = "zPointOfClosestApproachToPV_";
      zPointOfClosestApproachToPV = dqmStore_->book1D(histname+CatagoryName, histname+CatagoryName, VZBin, VZMin, VZMax);
      zPointOfClosestApproachToPV->setAxisTitle("z component of Track PCA to beam line (cm)",1);
    ...
    std::cout << "[TrackAnalyzer::bookHistosForHitProperties] DONE" << std::endl;
}

void TrackAnalyzer::bookHistosForLScertification(DQMStore * dqmStore_) {

  std::cout << "[TrackAnalyzer::bookHistosForLScertification] ..starting" << std::endl;
...
void TrackAnalyzer::bookHistosForBeamSpot(DQMStore * dqmStore_) {
  ...
  std::cout << "[TrackAnalyzer::bookHistosForBeamSpot] .. starting" << std::endl;
    ...
    if(doBSPlots_ || doAllPlots_) {
      ...
      zPointOfClosestApproachVsPhi = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, PhiBin, PhiMin, PhiMax, VZBinProf, VZMinProf, VZMaxProf, "");
    ...
    if(doPVPlots_ || doAllPlots_) {
      ...
      DistanceOfClosestApproachToPV = dqmStore_->book1D(histname+CatagoryName,histname+CatagoryName,DxyBin,DxyMin,DxyMax);
      ...
      DistanceOfClosestApproachToPVVsPhi = dqmStore_->bookProfile(histname+CatagoryName,histname+CatagoryName, PhiBin, PhiMin, PhiMax, DxyBin, DxyMin, DxyMax,"");
      ...
      xPointOfClosestApproachVsZ0wrtPV = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, Z0Bin, Z0Min, Z0Max, X0Bin, X0Min, X0Max,"");
      ...
      yPointOfClosestApproachVsZ0wrtPV = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, Z0Bin, Z0Min, Z0Max, Y0Bin, Y0Min, Y0Max,"");
    ...
    std::cout << "[TrackAnalyzer::bookHistosForBeamSpot] DONE" << std::endl;
...
{
  std::cout << "[TrackAnalyzer::analyze] .. starting" << std::endl;
  ...
  if ( doHitPropertiesPlots_ || doAllPlots_ ){
    ...
    std::cout << "[TrackAnalyzer::analyze] DONE w/ doHitPropertiesPlots_" << std::endl;
  }
  ...
  if (doGeneralPropertiesPlots_ || doAllPlots_){
    ...
    std::cout << "[TrackAnalyzer::analyze] DONE w/ doGeneralPropertiesPlots_" << std::endl;
  }

  if ( doLumiAnalysis_ ) {
    NumberOfRecHitsPerTrack_lumiFlag -> Fill(nRecHits);
    Chi2oNDF_lumiFlag                -> Fill(chi2oNDF);
    std::cout << "[TrackAnalyzer::analyze] DONE w/ doLumiAnalysis_" << std::endl;
  }
  ...
  if(doBSPlots_ || doAllPlots_) {
    ...
    std::cout << "[TrackAnalyzer::analyze] DONE w/ doBSPlots_" << std::endl;
  }
  ...
  if(doPVPlots_ || doAllPlots_) {
    ...
    std::cout << "[TrackAnalyzer::analyze] DONE w/ doPVPlots_" << std::endl;
  }
...
void TrackAnalyzer::bookHistosForState(std::string sname, DQMStore * dqmStore_) 
{
  ...
  std::cout << "[TrackAnalyzer::bookHistosForState] .. starting " << sname << std::endl;
	...
	tkmes.Chi2oNDFVsTheta->setAxisTitle("Track #chi^{2}/ndf",2);
      ...
      tkmes.Chi2ProbVsPhi = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, PhiBin, PhiMin, PhiMax, Chi2ProbMin, Chi2ProbMax);
      ...
      tkmes.Chi2ProbVsEta = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, EtaBin, EtaMin, EtaMax, Chi2ProbMin, Chi2ProbMax);
    ...
    tkmes.NumberOfValidRecHitsPerTrackVsPhi = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, PhiBin, PhiMin, PhiMax, RecHitMin, RecHitMax,"");
    tkmes.NumberOfValidRecHitsPerTrackVsPhi->setAxisTitle("Track #phi",1);
    tkmes.NumberOfValidRecHitsPerTrackVsPhi->setAxisTitle("Number of valid RecHits of each Track",2);
    
    histname = "NumberOfValidRecHitsPerTrackVsEta_" + histTag;
    tkmes.NumberOfValidRecHitsPerTrackVsEta = dqmStore_->bookProfile(histname+CatagoryName, histname+CatagoryName, EtaBin, EtaMin, EtaMax, RecHitMin, RecHitMax,"");
    tkmes.NumberOfValidRecHitsPerTrackVsEta->setAxisTitle("Track #eta",1);
    tkmes.NumberOfValidRecHitsPerTrackVsEta->setAxisTitle("Number of valid RecHits of each Track",2);
    ...
    std::cout << "[TrackAnalyzer::bookHistosForState] DONE" << std::endl;
...
void TrackAnalyzer::bookHistosForTrackerSpecific(DQMStore * dqmStore_) 
{
  ...
  std::cout << "[TrackAnalyzer::bookHistosForTrackerSpecific] ..starting" << std::endl;
    ...
    for ( auto det : subdetectors ) {
      ...
      histname = "NumberOfRecHitsPerTrack_" + det + "_" + CatagoryName;
      recHitsPerSubDet_mes.NumberOfRecHitsPerTrack = dqmStore_->book1D(histname, histname, detBin, -0.5, double(detBin)-0.5);
      recHitsPerSubDet_mes.NumberOfRecHitsPerTrack->setAxisTitle("Number of " + det + " valid RecHits of each Track",1);
      recHitsPerSubDet_mes.NumberOfRecHitsPerTrack->setAxisTitle("Number of Tracks", 2);

      histname = "NumberOfRecHitsPerTrackVsPhi_" + det + "_" + CatagoryName;
      ...
      recHitsPerSubDet_mes.NumberOfRecHitsPerTrackVsPhi->setAxisTitle("Number of " + det + " valid RecHits of each Track",2);

      histname = "NumberOfRecHitsPerTrackVsEta_" + det + "_" + CatagoryName;
      ...
      recHitsPerSubDet_mes.NumberOfRecHitsPerTrackVsEta->setAxisTitle("Number of " + det + " valid RecHits of each Track",2);

      histname = "NumberOfLayersPerTrack_" + det + "_" + CatagoryName;
      recHitsPerSubDet_mes.NumberOfLayersPerTrack = dqmStore_->book1D(histname, histname, detBin, -0.5, double(detBin)-0.5);
      recHitsPerSubDet_mes.NumberOfLayersPerTrack->setAxisTitle("Number of " + det + " valid Layers of each Track",1);
      recHitsPerSubDet_mes.NumberOfLayersPerTrack->setAxisTitle("Number of Tracks", 2);

      histname = "NumberOfLayersPerTrackVsPhi_" + det + "_" + CatagoryName;
      ...
      recHitsPerSubDet_mes.NumberOfLayersPerTrackVsPhi->setAxisTitle("Number of " + det + " valid Layers of each Track",2);

      histname = "NumberOfLayersPerTrackVsEta_" + det + "_" + CatagoryName;
      ...
      recHitsPerSubDet_mes.NumberOfLayersPerTrackVsEta->setAxisTitle("Number of " + det + " valid Layers of each Track",2);
...
void TrackAnalyzer::fillHistosForTrackerSpecific(const reco::Track & track) 
{
  ...
  for ( std::map<std::string,TkRecHitsPerSubDetMEs>::iterator it = TkRecHitsPerSubDetMEMap.begin();
    ...
    NumberOfRecHitsPerTrack      -> Fill(nValidRecHits); 
    NumberOfRecHitsPerTrackVsPhi -> Fill(phi,    nValidRecHits);
    NumberOfRecHitsPerTrackVsEta -> Fill(eta,    nValidRecHits);
    
    NumberOfLayersPerTrack      -> Fill(nValidLayers);
    NumberOfLayersPerTrackVsPhi -> Fill(phi,     nValidLayers);
    NumberOfLayersPerTrackVsEta -> Fill(eta,     nValidLayers);
  }

  std::cout << "[TrackAnalyzer::bookHistosForTrackerSpecific] DONE" << std::endl;
...
void TrackAnalyzer::setLumiFlag() { 
  ...
  std::cout << "[TrackAnalyzer::setLumiFlag] .. starting" << std::endl;
  TkParameterMEs tkmes;
  ...
  std::cout << "[TrackAnalyzer::setLumiFlag] DONE" << std::endl;
}
//
// -- Apply SoftReset 
//
